...
if load_check=="y"or load_check=="Y":
    ...
    with open('./savepoints/'+str(i_episode)+'episodes', "r") as file:
        lines = file.read()
        i_episode = int(lines)
...
#for i_episode in count():
    ...
    if i_episode%1000==0 and i_episode !=0:
        ...
        with open('./savepoints/'+str(i_episode)+'steps', "w") as file:
            file.write(str(steps_done))
        with open('./savepoints/'+str(i_episode)+'episodes', "w") as file:
            file.write(str(i_episode))
        with open('./savepoints/'+str(i_episode)+'total_rewards.json', "w") as file:
